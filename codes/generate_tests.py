#!/usr/bin/env python3
"""
Test Generation Script - OpenAI Version
Generates comprehensive test suites for React applications using OpenAI models.
"""
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Generate comprehensive test suite for React application")
...
"""
    ...
    if 'unit' in test_types:
        prompts['unit'] = {
            ...
            'user': f"""Project: {args.project_name}
...
Generate complete test files with proper imports and setup. Use {args.test_framework} and React Testing Library."""
        }
...
Generate complete integration test suites with proper mocking and test utilities."""
        }
...
Generate Playwright test files with proper page object models and test utilities."""
        }
...
Generate accessibility test suites with proper setup and comprehensive coverage."""
        }
    
    return prompts

def generate_tests_with_openai(client, prompts, args):
...
def main():
    ...
    generated_tests, total_cost = generate_tests_with_openai(client, prompts, args)
